...
dados <- read.csv("data_market.csv")
dim(dados)
View(dados)
summary(dados)
str(dados)
...
pacote_split <- pacote[,1:6]
str(pacote_split)

pacote_split <- split(pacote_split$Item01, pacote_split$Item02, pacote_split$Item03, pacote_split$Item04, pacote_split$Item05, pacote_split$Item06, drop = TRUE)
View(pacote_split)


#----- Definicoes de metricas para MBA:
